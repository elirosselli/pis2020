...
| `ErrorInvalidSub`            | gubuy_invalid_sub                          | Sub returned by API does not match given sub.                                                                                                                                                                       | Cuando el sub correspondiente al token utilizado no coincida con el sub de la respuesta del OP.                                                                     | Revisar que el sub correspondiente con el token coincida con el sub de la respuesta del OP.             |
