...
| `ErrorInvalidUrlLogout`            | invalid_url_logout                          | Invalid returned url for logout.                                                                                                                                                                       | Cuando el parámetro idToken no es vacío, y la URL contenida en la respuesta del OP no coincide con el logoutEndpoint.                                                                     |              |
